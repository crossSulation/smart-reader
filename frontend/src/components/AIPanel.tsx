      ...
      <div className="flex min-h-0 flex-1 flex-col p-4">
        {selectedExcerpt && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
            <div
              className="w-full max-w-md rounded-lg border border-blue-200 bg-white p-4 shadow-lg"
              onClick={(e) => e.stopPropagation()}
            >
              <div className="mb-3 flex items-center justify-between">
                <h3 className="text-sm font-semibold uppercase tracking-wide text-blue-700">Selected Text</h3>
                <button
                  type="button"
              ...
              <p className="mb-4 max-h-32 overflow-y-auto rounded border border-blue-100 bg-blue-50 p-2 text-sm text-blue-900">
                {selectedExcerpt}
              </p>
              ...
              <div className="mb-3">
                ...
                <input
                  ...
                  className="w-full rounded border border-gray-300 bg-white px-2 py-1.5 text-xs text-gray-800 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-300"
                />
              </div>
              ...
              <div className="mb-3 flex flex-wrap gap-2">
                <button
                  ...
                  className="flex-1 rounded border border-blue-300 bg-white px-3 py-2 text-xs font-medium text-blue-700 hover:bg-blue-50 disabled:cursor-not-allowed disabled:opacity-60"
                >
                ...
                <button
                  ...
                  disabled={!activeBookIdForAi || savingNote || savingFlashcard}
                  className="flex-1 rounded border border-blue-600 bg-blue-600 px-3 py-2 text-xs font-medium text-white hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-60"
                >
              ...
              {learningStatus && (
                <div className="mb-2 text-xs text-gray-600">{learningStatus}</div>
              )}
              {!activeBookIdForAi && (
                <div className="text-xs text-amber-700">Upload/index must complete before saving learning items.</div>
              )}
            </div>
          </div>
        )}
        ...
        {!activeBookIdForAi ? (
          ...
          <div className="flex min-h-0 flex-1 flex-col">
            <div className="mb-3 flex gap-1 rounded border border-gray-200 bg-gray-50 p-1">
              <button
                type="button"
